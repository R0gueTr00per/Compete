<x-filament-panels::page>
    ...
    @forelse ($competitions as $competition)
        ...
        {{-- Competition --}}
        <div x-data="{ open: false }" class="mb-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-sm overflow-hidden">
            <button
                type="button"
                x-on:click="open = !open"
                class="flex w-full items-center justify-between gap-3 px-4 py-3 text-left hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                <div class="min-w-0">
