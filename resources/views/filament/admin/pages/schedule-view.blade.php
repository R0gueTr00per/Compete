        ...
        <x-filament::section>
            ...
            <div class="mt-3 flex flex-wrap gap-4 text-xs text-gray-600">
                <span class="flex items-center gap-1.5">
                    <span class="w-2.5 h-2.5 rounded-sm inline-block" style="background-color:#bbf7d0"></span> Complete
                </span>
                <span class="flex items-center gap-1.5">
                    <span class="w-2.5 h-2.5 rounded-sm inline-block" style="background-color:#c7d2fe"></span> 2+ competitors
                </span>
                <span class="flex items-center gap-1.5">
                    <span class="w-2.5 h-2.5 rounded-sm inline-block" style="background-color:#fde68a"></span> Scheduled
                </span>
                <span class="flex items-center gap-1.5">
                    <span class="w-2.5 h-2.5 rounded-sm inline-block" style="background-color:#ffffff;border:1px solid #9ca3af"></span> Pending
                </span>
            </div>
        </x-filament::section>
