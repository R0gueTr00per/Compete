...
<head>
    ...
    <meta property="og:description" content="Run tournaments, manage registrations, check in competitors with QR codes, and track live scores — powered by AI insights. One platform for organisations that take competition seriously.">
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .card h3 { font-size: 1.05rem; font-weight: 700; margin-bottom: .5rem; color: var(--white); }
    ...
    <section class="hero" aria-labelledby="hero-heading">
        <div class="hero-inner">
            ...
            <div class="hero-ctas">
                ...
                @if (Route::has('login'))
                    @auth
                        <a href="{{ url('/dashboard') }}" class="btn-secondary">Go to Dashboard &rarr;</a>
                    @else
                        <a href="{{ route('login') }}" class="btn-secondary">Log In &rarr;</a>
                    @endauth
                @endif
            </div>
        </div>
    ...
    <section class="features" id="features" aria-labelledby="features-heading">
        ...
        <div class="grid-features">
            ...
            <article class="card">
                ...
                <p>Create events, configure divisions, build draws and manage the full competition lifecycle from a single intuitive admin panel.</p>
            </article>
            ...
            <article class="card">
                ...
                <p>A full back-office for your organisation — manage members, clubs, officials and events across multiple dojos from one place.</p>
            </article>
