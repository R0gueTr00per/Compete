        ...
        return $table
            ...
            ->actions([
                EditAction::make()
                    ...
                    ->requiresConfirmation(fn ($record) => Division::where('rank_band_id', $record->id)->exists())
                    ->modalHeading('Edit rank band')
                    ->modalDescription(fn ($record) => Division::where('rank_band_id', $record->id)->count() . ' division(s) use this rank band and will be deleted when you save. You can regenerate divisions afterwards.')
                    ->after(fn ($record) => Division::where('rank_band_id', $record->id)->delete()),
