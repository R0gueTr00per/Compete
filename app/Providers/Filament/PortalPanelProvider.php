                ...
                function () {
                    ...
                    return new \Illuminate\Support\HtmlString('
                        <div class="px-3 pb-4 pt-2 border-t border-gray-200 dark:border-white/10">
                            <a href="/admin" class="flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-white/5 transition-colors">
